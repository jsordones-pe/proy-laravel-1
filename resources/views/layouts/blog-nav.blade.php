...
<nav>
   <ul>
        ...
        <li><a class="{{ request()->routeIs('posts.*') ? 'text-gray-400' : 'text-gray-600'}}" href="{{ route('posts.index') }}">Blog</a></li>
        <li><a class="{{ request()->routeIs('about') ? 'text-gray-400' : 'text-gray-600'}}" href="{{ route('about') }}">Nosotros</a></li>
        <li><a class="{{ request()->routeIs('contact') ? 'text-gray-400' : 'text-gray-600'}}" href="{{ route('contact') }}">Contacto</a></li>
...
--}}
    <header class="bg-white px-6 shadow dark:bg-slate-900">
      <div  class="mx-auto flex h-16 max-w-6xl items-center justify-between">
        <button id="toggle-mobile-menu" class="-ml-1 rounded p-1 text-slate-500 transition-colors hover:bg-sky-500 hover:text-slate-100 focus:ring-2 focus:ring-slate-200 dark:text-slate-400 dark:hover:text-slate-100 md:hidden">
        ...
        <a class="hidden text-sky-500 duration-200 hover:rotate-6 md:block"
          href="{{ route('home') }}"
        >
          <svg
            class="h-8 w-8"
